...
#include <conio.h>
using namespace std;
string odszyfrowanie(string napis);
fstream plik1,plik2;
bool jest[123];
char tab[6][6];
...
int main()
{
 ...
 string klucz,alfabet="a¹bcædeêfghijkl³mnñoópqrsœtuvwxyz¿Ÿ ",napis,sciezka="",pom,pom2;
 cout<<"Podaj klucz: ";
 cin>>klucz;
 system("cls");
 cin.ignore();
